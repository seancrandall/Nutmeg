...
void Settings::populate()
{
    ...
    // Ensure websocket defaults exist in config
    setValue("websocket/port", value("websocket/port", 8787));
    setValue("websocket/bind", value("websocket/bind", QStringLiteral("0.0.0.0")));
