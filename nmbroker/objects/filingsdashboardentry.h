#pragma once
/**
 * filingsDashboardEntry
 * Auto-generated data holder for rows from view `filingsDashboardComplete`.
 *
...
class filingsDashboardEntry {
public:
    filingsDashboardEntry() = default;
    ~filingsDashboardEntry() = default;
    filingsDashboardEntry(const filingsDashboardEntry&) = default;
